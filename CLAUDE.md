...
- Refer to `.claude/skills/` for architecture, implementation patterns, UI implementation, and testing guidance (`innochat-overview`, `innochat-implementation`, `innochat-ui`, `innochat-testing`).
