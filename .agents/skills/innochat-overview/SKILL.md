---
name: innochat-overview
description: Use when starting work on InnoChat, asking about project structure, where to put new code, tech stack, operating modes, or codebase architecture. Triggers on "innochat", "this project", "start feature", "project overview", "codebase architecture", "where does X go", "project structure".
---

# InnoChat — Project Overview

## What is this project?

**InnoChat** is a Vue 3 + Nuxt 4 SPA (SSR disabled) that serves as a rich frontend client to a C# backend API. It operates in two distinct modes: **Authenticated** (full desktop chat UI) and **Public** (iframe-embeddable, restricted single-agent chat).
